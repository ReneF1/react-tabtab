...
var _NativeListener = require("./utils/NativeListener");
...
var TabListComponent = function (_React$Component) {
  ...
  _createClass(TabListComponent, [{
    ...
    value: function componentDidMount() {
      ...
      if (!this.props.invisibleTabs && this.props.activeIndex > 0) this.scrollToIndex(this.props.activeIndex, "left");
    }
  }, {
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (prevProps.activeIndex !== this.props.activeIndex) {
        ...
        if (!this.props.invisibleTabs && this.props.activeIndex && this.props.activeIndex > -1 && this.tabRefs && this.tabRefs.length > 0) {
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        this.state.showModalButton && ExtraModalButton ? React.createElement(ExtraModalButton, {
          ref: function ref(node) {
        ...
        React.createElement(
          ...
          this.state.showModalButton && !ExtraModalButton ? React.createElement(
            FoldButton,
            {
              ref: function ref(node) {
                return _this4.foldNode = node;
          ...
          !invisibleTabs && React.createElement(
            _NativeListener2.default,
            {
