...
var NativeListener = function (_Component) {
    inherits(NativeListener, _Component);

    function NativeListener() {
        classCallCheck(this, NativeListener);
        return possibleConstructorReturn(this, (NativeListener.__proto__ || Object.getPrototypeOf(NativeListener)).apply(this, arguments));
    }

    createClass(NativeListener, [{
